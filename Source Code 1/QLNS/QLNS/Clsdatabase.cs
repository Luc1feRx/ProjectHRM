...
namespace QLNS
{
    class Clsdatabase
    {
        ...
        public void loadcombobox(ComboBox cb, string strselect, int chiso)
        {
            ketnoi();
        ...
        public void loaddatetime(DateTimePicker cb, string strselect, int chiso)
        {
            ketnoi();
            sqlcom = new SqlCommand(strselect, sqlcon);
            sqldr = sqlcom.ExecuteReader();
        ...
        public void loadtextboxchiso(TextBox cb, string strselect,int chiso)
        {
            ketnoi();
            sqlcom = new SqlCommand(strselect, sqlcon);
            sqldr = sqlcom.ExecuteReader();
        ...
        public bool kt(string dauvao, string strsql, int chiso)
        {
            bool ok = false;
            ketnoi();
            sqlcom = new SqlCommand(strsql, sqlcon);
        ...
        public void loatextbox(TextBox tb, string strselect, int chiso)
        {
            ketnoi();
            sqlcom = new SqlCommand(strselect, sqlcon);
            sqldr = sqlcom.ExecuteReader();
